...
try {
    ...
    $stmt = $pdo->prepare("INSERT INTO user (name,mail,age,comments)VALUES(?,?,?,?)");
    $stmt->execute(array($_POST["name"], $_POST["mail"], $_POST["age"], $_POST["comments"]));
} catch (PDOException $e) {
    echo mb_convert_encoding($e->getMessage(), 'utf-8', 'sjis'); //例外発生時にエラーまっせーじを出力
}
